...
if( result_code == 0 ) : # SAT
    ...
    heule_model.add_solution_json(solution_name=f'{SOLUTION_NAME}')
    ...
    heule_model.add_empty_solution_json(solution_name=f'{SOLUTION_NAME}')
    heule_model.export_json_solution()
else: # UNKNOWN
    print("The solver returned UNKNOWN (timeout reached) ⚠️")
    heule_model.add_empty_solution_json(solution_name=f'{SOLUTION_NAME}', timed_out=True)
    heule_model.export_json_solution()
print("-------------------------------------------------------------------------------------------------")
################################# MAIN ###############################
