...
if( result_code == 0 ) : # SAT
    ...
    bitwise_model.add_solution_json(solution_name=f'{SOLUTION_NAME}')
    ...
    bitwise_model.add_empty_solution_json(solution_name=f'{SOLUTION_NAME}')
    bitwise_model.export_json_solution()
else: # UNKNOWN
    print("The solver returned UNKNOWN (timeout reached) ⚠️")
    bitwise_model.add_empty_solution_json(solution_name=f'{SOLUTION_NAME}', timed_out=True)
    bitwise_model.export_json_solution()
print("-------------------------------------------------------------------------------------------------")
